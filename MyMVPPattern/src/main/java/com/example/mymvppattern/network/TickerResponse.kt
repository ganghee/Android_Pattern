package com.example.mymvppattern.network
...
data class TickerResponse(
    ...
    fun toTicker(): FormatTickers{
        ...
        val toSignChangeRate = FormatText.formatSignedChangeRate(signedChangeRate)
        val toRateColor = FormatText.formatRateColor(signedChangeRate)
        val toAccTradePrice24h = FormatText.formatAccTradePrice24h(accTradePrice24h,market.split("-")[0])
